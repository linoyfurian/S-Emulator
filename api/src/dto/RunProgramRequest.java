...
public class RunProgramRequest {
    ...
    public RunProgramRequest(long credits, String programName, String architecture, boolean isProgram, int degreeOfExpand,Map<String, Long> originalInputs, long[] inputs) {
